...
<body>
    ...
    <div class="w3l-banner-content">
      <div class="container">
        <div class="bannerhny-info text-center">
          ...
          <h3 class="">Dịch Vụ Thiết Kế <span style="color: #2caee2;">Website</span> Trọn Gói</h3>
  ...
  <!-- <div class="position-relative">
    <div class="shape overflow-hidden">
      <svg viewBox="0 0 2880 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 100H1437.5H2880V0H2160C1442.5 120 720 0 720 0H0V100Z" fill="currentColor"></path>
      </svg>
    </div>
  </div> -->
      ...
      <div class="row whybox-wrap">
        <div class="col-lg-6 whybox-wrap-left">
          <div class="title-content text-left">
            ...
            <h3 class="title-w3l mb-sm-5 mb-4 pb-2">Vì Sao Bạn Nên Chọn Chúng Tôi?</h3>
          </div>
        ...
        <div class="col-lg-6 whybox-wrap-right pl-lg-5 position-relative mt-lg-0 mt-4">
          <img src="assets/images/banner4.webp" alt="" class="img-fluid radius-image">
  ...
  <!-- <script>
    // Sử dụng sessionStorage để lưu vị trí cuộn
