      ...
      <nav class="navbar navbar-expand-lg stroke">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-lg-auto">
            <!-- Trang Chủ -->
            <li class="nav-item <?php if($current_page == 'index' || $current_page == '') { echo 'active'; } ?>">
            ...
            <!-- Dịch vụ Website -->
            <li class="nav-item dropdown <?php if($current_page == 'website-tron-goi' || $current_page == 'thiet_ke_theo_yeu_cau') { echo 'active'; } ?>">
